...
按照`3.1`步骤部署完成后，前往仓库[MarSeventh/Sanyue-ImgHub](https://github.com/ED-Builder/Sanyue-ImgHub?tab=readme-ov-file)，按照操作说明进行DIY和打包操作，最后将打包好的`/dist`目录中的内容替换到该仓库的根目录下即可（复制+替换）。
...
- 参见[Issue #8](https://github.com/ED-Builder/ImgBed/issues/8)
...
前端开源，参见[MarSeventh/Sanyue-ImgHub](https://github.com/ED-Builder/Sanyue-ImgHub?tab=readme-ov-file)项目。
